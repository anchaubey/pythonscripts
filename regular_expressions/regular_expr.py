...
re.match will only match if the search key comes at first
re.search will search at any place
re.findall will print the number of times it occured in a list.
re.finditer
----------------------------------------------------------------------------------
...
if re.match(pattern,"fdfdfeggseggseggspuma"):
    print("match found")
else:
    print("Not")

if re.search(pattern,"fddfdeggseggseggspuma"):
    print("match found")
else:
    print("Not")


print(re.findall(pattern,"fddfdeggseggseggspuma"))
...
match = re.search(r'word:\s\w\w\w', str)
...
file = open(r"C:\Users\ankit\Desktop\findreplace.txt", "r+")
string = file.read()
pattern = r"John"

new_string = re.sub(pattern, "Rob",string)
...
Dot and carrot metacharacter
#carrot ^ metacharacter
...
#AA1a12a
pattern = r"[A-Z][A-Z][0-9][a-z][0-9][0-9][a-z]"
if re.search(pattern, "AA1n43p"):
    print("Match Found")
...
#APGPC9399P
pattern = r"[A-Z,a-z][A-Z,a-z][A-Z,a-z][A-Z][A-Z][0-9][0-9][0-9][0-9][A-Z]"
PAN = input("Please input the PAN number: ")
if re.search(pattern, PAN):
    print("Looks like a PAN number.")
else:
...
#ankit@gmail.com
pattern = r"[A-Z,a-z][A-Z,a-z][A-Z,a-z][A-Z,a-z][A-Z,a-z][@][a-z][a-z][a-z][a-z][a-z][.][a-z][a-z][a-z]"
PAN = input("Please enter your email: ")
if re.search(pattern, PAN):
    print("Valid.")
else:
    print("Invalid")
...
So, here we could have either one repetition or multiple repetition of bacon after egg but giving only bacon will not qualify. it should start with eggs
not giving bacon is also fine.
...
if re.match(pattern, "eggsbaconeggsbacon"):
    print("Match Found")
...
We can have either one or none occurances of eggs
...
#Escape the period if you want to use
...
an upper case \D matches anything which is not a digit
...
with open('C:\\Users\\E211568\\Desktop\\emails.txt', 'r') as f:
    contents = f.read()
...
#Only matching an 800 or a 900 number pattern
...
emails = '''
ankitchaubey@gmail.com
ankit.chaubey@university.edu
ankit-321-chaubey@my-work.net
'''
...
file = open(r"C:\\Users\\E211568\\Desktop\\file1.txt", "r+")
string = file.read()
pattern = r"tuesday"

file.seek(0,0)
new_string = re.sub(pattern, "december",string)
file.writelines(new_string)
file.close()
...
file =  open('C:\\Users\\E211568\\Desktop\\emails.txt', 'r')
contents = file.read()
...
text_file = r"/root/text444.txt"
csv_file = r"/root/text444.csv"
